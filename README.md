...
All repositories under the [learning-go-developer](https://github.com/learning-go-developer) organization are provided "as is" without any warranties.  
...
Все репозитории организации [learning-go-developer](https://github.com/learning-go-developer) предоставляются "как есть" без каких-либо гарантий.  
